...
mesh.data / mesh1.data are FIXED-FORMAT text:
    ...
    read(11,'(16i6)') ((ien2d(i,j),i=1,3),j=1,numel2d)
    ...
    def write_mesh_data(
        ...
        with open(path, "w") as f:
            ...
            for i in range(
                ...
                # Match the legacy Fortran read format (16i6):
                # 16 integer fields, each exactly 6 characters wide.
                f.write(
                    "".join(
                        f"{int(v):6d}"
                        for v in chunk
