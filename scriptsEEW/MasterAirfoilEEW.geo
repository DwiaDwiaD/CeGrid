...
Transfinite Curve{-1} = N_UP Using Progression 1.02;
Transfinite Curve{-3} = N_UP Using Progression 1.00;
Transfinite Curve{2} = N_LOW Using Progression 1.02;
Transfinite Curve{4} = N4 Using Progression 0.97;
Transfinite Curve{5} = N5;
Transfinite Curve{51,56,-61} = wakeres Using Progression 1.007;
